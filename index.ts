...
export {alignWithDOM, close, createPatchInner, createPatchOuter, currentElement,currentContext, currentPointer, open, patchInner as patch, patchInner, patchOuter, skip, skipNode} from './src/core';
